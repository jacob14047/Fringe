...
class SimulationConfig:
    ...
    eve_attack_enabled: bool = True    # Abilita/disabilita Eve globalmente
    eve_pns_enabled: bool = True       # Photon Number Splitting attack
...
class BB84SimulationV2:
    ...
    def run_single_iteration_v2(self, iteration_idx: int) -> dict:
        ...
        # <-- NUOVO: Decide se questa iterazione è attaccata (per random attacks)
        ...
        elif not self.config.eve_attack_enabled:
            self._attack_active_this_iteration = False
        ...
        for i in range(N):
            ...
            received_state = self.channel.transmit_qubit(alice_states[i])
